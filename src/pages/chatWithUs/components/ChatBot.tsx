...
import { INITIAL_CHAT_BOT, INITIAL_CHAT_HM, INITIAL_CHAT_TA } from "./constant";
...
const ChatBot = () => {
  ...
  useEffect(() => {
    if (chatAgent === "Sage HR Assistance Bot") setChatData(INITIAL_CHAT_BOT);
    else if (chatAgent === "Talent Acquisition") setChatData(INITIAL_CHAT_TA);
    else setChatData(INITIAL_CHAT_HM);
  }, [chatAgent]);
